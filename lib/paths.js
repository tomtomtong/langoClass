...
const uploadsCommunityDir = path.join(uploadsRoot, "community");
...
function ensurePersistentDirs() {
  for (const dir of [
    ...
    uploadsMaterialDir,
    uploadsCommunityDir,
    path.join(dataDir, "question-tts"),
  ]) {
...
module.exports = {
  ...
  communityCoursesFile: path.join(dataDir, "community-courses.json"),
  ...
  appLogsFile: path.join(dataDir, "app-logs.ndjson"),
};
